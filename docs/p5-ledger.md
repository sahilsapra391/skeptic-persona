...
| # | Item | Status |
|---|---|---|
| 1 | Congress lane: diagnose zero cards, fix senate_ptr, first live CONGRESS_PTR card | **diagnosed + fixed, merged-deployed** ([#155](https://github.com/sahilsapra391/skeptic-persona/pull/155)); the first card awaits the next filing, and the 13:30Z Senate slot is the falsifiable test (D-36, D-37) |
