...
| # | Item | Status |
|---|---|---|
| 1 | Congress lane: diagnose zero cards, fix senate_ptr, first live CONGRESS_PTR card | **diagnosed + fixed, merged-deployed**; first card awaits the next filing (see below) | [#155](https://github.com/sahilsapra391/skeptic-persona/pull/155) |
| 2 | Render lane v1 (single-stat + diff templates, 13F breakdown card, CHUBB LTD SWITZ proof), image on every Telegram delivery | **built + merged-deployed**; `sendPhoto` wired, attaching it to the live card path is the remaining half | [#156](https://github.com/sahilsapra391/skeptic-persona/pull/156) |
| 3 | INSTITUTIONAL_13F_BREAKDOWN archetype + owner exemplar + live generation | **archetype + payload builder merged-deployed**; exemplar HELD at 273 (see below), so the gate does not unblock | [#157](https://github.com/sahilsapra391/skeptic-persona/pull/157) |
