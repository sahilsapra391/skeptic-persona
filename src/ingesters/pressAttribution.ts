...
export const PRESS_ATTRIBUTION: Readonly<Record<string, string>> = {
  ...
  "European Central Bank": "per ECB",
  "Bank of Canada": "per Bank of Canada",
  "UK ONS": "per the Office for National Statistics",
  "UK OFSI": "per OFSI",
  "Reserve Bank of India": "per the Reserve Bank of India",
  SEBI: "per SEBI",
  "SEC Commissioners": "per SEC",
  CFPB: "per the CFPB",
  GAO: "per GAO",
  "European Banking Authority": "per the EBA",
  "Bank of England": "per Bank of England",
  "Sveriges Riksbank": "per Sveriges Riksbank",
  "Bureau of Economic Analysis": "per the BEA",
  "US Energy Information Administration": "per the EIA",
  WTO: "per the WTO",
  "UK CMA": "per the CMA",
  "HM Treasury": "per HM Treasury",
  FINMA: "per FINMA",
  CFTC: "per CFTC",
  FTC: "per FTC",
  "UK FCA": "per the FCA",
